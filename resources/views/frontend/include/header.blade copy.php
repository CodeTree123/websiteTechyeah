      ...
      <div class="collapse navbar-collapse" id="navbarsExample05">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Why Tech yeah!</a>
        ...
        <a href="" class="btn btn-outline-primary">Become a Labor</a>
        </div>
      </div>
    </div>
  </nav> 
    <div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="border-top mt-2 ">
